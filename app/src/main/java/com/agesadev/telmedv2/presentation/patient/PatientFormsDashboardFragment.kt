 ...
 * Use the [PatientFormsDashboardFragment.newInstance] factory method to
...
class PatientFormsDashboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PatientFormsDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PatientFormsDashboardFragment().apply {
